...
Here is an example to monitor wormhole WETH balance by using the WETH9 events.
...
* Deposit (See [defined](https://github.com/makerdao/sai/blob/master/src/weth9.sol#L36) in contract)
* Withdrawal (See [defined](https://github.com/makerdao/sai/blob/master/src/weth9.sol#L42) in contract)
* Transfer (See [defined](https://github.com/makerdao/sai/blob/master/src/weth9.sol#L73) in contract)
...
See the full guide of writing filters, see [event-filters.md](../../../developer-guides/sdk-guide/event-filters.md "mention")
