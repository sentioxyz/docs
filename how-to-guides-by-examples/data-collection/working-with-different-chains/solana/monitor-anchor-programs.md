...
{% hint style="info" %}
See this [repo](https://github.com/sentioxyz/sentio-sdk/tree/main/examples/aurory) for full implementation. To learn how to view metrics from the UI, go to [view-metrics.md](../../../visualize-results/view-metrics.md "mention")
{% endhint %}
