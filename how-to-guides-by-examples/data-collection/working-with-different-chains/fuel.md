...
* [FuelContext](https://sdk.sentio.xyz/interfaces/fuel.FuelLog.html):&#x20;
  * hold the the tools for doing data submission, like `eventLogger` and `meter`, which records [logs-in-processor](../../../developer-guides/sdk-guide/logs-in-processor "mention") and [metrics-in-processors](../../../developer-guides/sdk-guide/metrics-in-processors "mention").&#x20;
