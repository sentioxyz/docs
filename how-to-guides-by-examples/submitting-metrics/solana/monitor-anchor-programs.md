...
Here we use the Aurory example to demonstrate how to do this. Assuming we want to monitor its [staking contract](https://github.com/Aurory-Game/aurory-staking). We'd need to first copy the ABI json file generated by Anchor and put it into your directory `abi/solana`
