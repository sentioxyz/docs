...
* Counter: represents the cumulative value at a given time, each data point reported is a delta value to the last value. Usually used to record e..g the total number of tokens transfered.
