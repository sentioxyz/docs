...
&#x20;Suppose we have  a factory contract named `MyFactory` which create `MyPool` contract and submit `PoolCreated` event, then you can write your processor logics as follow
