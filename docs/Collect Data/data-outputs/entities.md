...
![img.png](https://media.githubusercontent.com/media/sentioxyz/docs/HEAD/assets/entity-sql-screenshot.png)

## Query Data using GraphQL

You can query the data store using GraphQL. The query schema will be generated based on the schema definition.

![img.png](https://media.githubusercontent.com/media/sentioxyz/docs/HEAD/assets/entity-graqphql-screenshot.png)