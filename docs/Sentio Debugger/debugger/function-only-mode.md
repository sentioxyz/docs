...
next:
  description: ''
---
By default, the debugger operates only at the function level.

## Use the debugger

The debugger has standard definitions for:
...
![](https://media.githubusercontent.com/media/sentioxyz/docs/HEAD/assets/image%20(8).png)
